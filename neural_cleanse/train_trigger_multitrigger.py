...
poisoned_data_filename='data/eyebrows_poisoned_data.h5'
trigger_filename='triggers/multitrigger.h5'
validation_data_filename='data/clean_validation_data.h5'
model_filename = 'models/multi_trigger_multi_target_bd_net.h5'
pruned_model_filename = 'models/pruned_multi_trigger_multi_target_bd_net.h5'
...
def main():
    ...
    bd_model.save("./models/retrain_with_trig_multi_trigger_multi_target_bd_net.h5")
